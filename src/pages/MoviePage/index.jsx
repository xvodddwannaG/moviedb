...
const MoviePage = () => {
  ...
  useEffect(() => {
    CallApi.get(`/movie/${id}`, { params: { language: "ru-RU" } }).then((res) =>
      setMovieData(res)
    );
  }, []);
  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage: `url("https://image.tmdb.org/t/p/w500${imagePathBackground}")`,
        }}
      >
          ...
          <div className="row justify-content-center">
            <div className="col-4">
              <img
                src={
                  imagePathPoster
                    ? `https://image.tmdb.org/t/p/w500${imagePathPoster}`
                    : ""
                }
                alt=""
              />
